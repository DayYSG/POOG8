...
public class POOP10 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("###############CUENTA ACTIVIDAD BANCARIA######################");
        
        ActividadBancaria actividad = new ActividadBancaria();
        
        try {
            actividad.depositar(10000);
            actividad.depositar(15000); // Esto lanzará una excepción
        } catch (Exception e) {
            System.out.println("Error: " + e.getMessage());
        }
        
        try {
            actividad.retirar(5000);
            actividad.retirar(3000);
            actividad.retirar(2000); // Esto lanzará una excepción
            actividad.retirar(1000); // Esto lanzará una excepción
        } catch (Exception e) {
            System.out.println("Error: " + e.getMessage());
        }
        
        System.out.println("Saldo actual: " + actividad.obtenerSaldo());
        System.out.println("Número de retiros: " + actividad.obtenerContadorRetiros());
